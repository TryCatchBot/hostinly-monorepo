    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 sm:pt-24 pb-16">
      ...
      <div className="absolute inset-0 z-0 bg-slate-900">
        <Image
          ...
          fill
          priority
          className="object-cover object-center scale-105 transition-transform duration-700 brightness-[1.15] contrast-[1.15] saturate-[1.25]"
          sizes="100vw"
        />
      </div>

      {/* Overlays */}
      <div className="absolute inset-0 bg-gradient-to-b from-black/70 via-black/20 to-black/70 z-[1]" />
      <div className="absolute inset-0 bg-black/20 z-[1]" />

      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 leading-tight px-1 text-white drop-shadow-2xl">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-white mb-6 sm:mb-8 max-w-2xl mx-auto px-2 drop-shadow-md">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-10 sm:mb-12 px-2">
            ...
            <Link href="/auth/signup?role=cohost">
              <Button
                variant="outline"
                size="lg"
                className="text-lg px-8 py-6 bg-transparent border-white text-white hover:bg-white hover:text-primary [&_svg]:text-white hover:[&_svg]:text-primary w-full sm:w-auto"
              >
